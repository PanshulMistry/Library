	...
	<div class="wrapper kode-header-class-3">
		...
		<div class="kode-banner">
			<ul class="bxslider">
				...
				<li><img src="homepage/banner-1.png" alt="">
					<div class="kode-caption-2">
						<h5></h5>
						<h2>Biggest Library</h2>
						<p>On most days, the Open Library is hard at work improving
							the experience it offers to students and teachers in classrooms.</p>
					</div></li>

				<li><img src="homepage/banner-2.png" alt="">
					<div class="kode-caption-2">
				...
				<li><img src="homepage/banner-3.png" alt="">
					<div class="kode-caption-2">
						<h5>Are you searching a book...?</h5>
						<h2>Biggest Library</h2>
						<p>Sed ut perspiciatis unde omnis iste natus error sit
