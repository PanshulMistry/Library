...
<body>
	...
	try {
		...
		Login login2 = (Login) httpSession.getAttribute("adminBean");
	%>
	<%
	if (login2 != null) {
	%>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="UserLogin"
					method="post">
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="signup2.jsp"> Create your Account <i
