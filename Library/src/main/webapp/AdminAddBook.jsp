...
<!--                         <label for="bookname">Book Name</label> -->
                        <input type="text" class="form-control" autofocus id="bookname" name="bookname" placeholder="Book Name">
                      </div>
                      <div class="form-group col-md-6">
<!--                         <label for="authorname">Author Name</label> -->
                      ...
                      <div class="form-group col-md-6">
                        <label for="bookimg">Upload Book image</label><input type="file" class="form-control" id="bookimg" name="bookimg">
                      </div>
                      <div class="form-group col-md-6">
<!--                         <label for="dates">PubLish Date</label> -->
                        <input type="date" class="form-control" id="publishdate" name="publishdate" placeholder="Date">
                      </div>
                      <div class="form-group col-md-12" style="text-align: center;">
<!--                         <label for="bookdesc" >Book Description</label> -->
                        <textarea class="form-control" id="bookdesc" name="bookdesc" placeholder="Book Description"></textarea>
                      </div>
                      <div class="form-group col-md-6">
                        <label for="bookimg">Upload Book</label><input type="file" class="form-control" id="bookpdf" name="bookpdf">
                      </div>
