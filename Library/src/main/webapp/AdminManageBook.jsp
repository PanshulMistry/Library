                    ...
                    <tbody>
					 ...
					 <%   for(Book b: bookList) {%>
					    <tr>
                            ...
                            <td>
                            	<img src="data:image/jpg;base64,<%=b.getImgstring()%>" alt="" width="100" height="150">
                            </td>
                            <td>
                            	<%=b.getBook_description() %>
                            </td>
                            <td style="align-items:center ;">
<!--                                 <form action="/return" method="post"> -->
<!--                                     <input type="hidden" name="" value="bookid"> -->
                                    <a href="AdminEditBook?page=1&bookid=<%=b.getBook_id()%>"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></a>
<!--                                 </form> -->
                            </td>
